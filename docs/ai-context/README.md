...
Concise, scannable rule references designed for AI agents (Codex, Claude Code, Cursor) to load without burning context on full prose docs. Each file mirrors a human-friendly source under `../guides/` or `../rules/`.
...
| [rules.md](rules.md) | Style + naming + forbidden patterns | [../rules/coding_rules.md](../rules/coding_rules.md), [../rules/code_formatting.md](../rules/code_formatting.md), [../rules/naming.md](../rules/naming.md) |
