...
class UikitLocalizer {
  ...
  /// `Pagination`
  String get paginationWidgets {
    return Intl.message(
      'Pagination',
      name: 'paginationWidgets',
      desc: '',
      args: [],
    );
  }
  ...
  String get paginationWidgetsDescription {
    return Intl.message(
      'Paginated list with pull-to-refresh',
      name: 'paginationWidgetsDescription',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Item {index}`
  String paginationItem(int index) {
    return Intl.message(
      'Item $index',
      name: 'paginationItem',
      desc: '',
