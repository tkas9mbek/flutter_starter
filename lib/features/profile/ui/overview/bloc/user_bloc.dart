...
sealed class UserState with _$UserState {
  ...
  const factory UserState.success(User user) = SuccessUserState;
  const factory UserState.failure(AppException exception) = FailureUserState;

  bool get isLoading => this is LoadingUserState;
}
